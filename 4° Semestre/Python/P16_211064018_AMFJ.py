...
def Ejercicio13():
    exec(open("P13_211064018_AMFJ.py").read())
def Ejercicio14():
    exec(open("P14_211064018_AMFJ.py").read())
def Ejercicio15():
    exec(open("P15_211064018_AMFJ.py").read())
app = Tk()
...
btnEjercicio11 = Button(vp, text="", command=Ejercicio13)
