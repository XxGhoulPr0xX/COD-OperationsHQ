...
class Graficar:
    def __init__(self, frame):
        ...
        self.cabeza = plt.Circle((0, 2), 0.3, color='black', fill=True)  # Agregar la circunferencia
    ...
    def dibujar(self, pierna_der_x, pierna_der_y, pierna_izq_x, pierna_izq_y, torso_x, torso_y, circle_x, circle_y, arm_izq_x, arm_izq_y, arm_der_x, arm_der_y):
        # Actualizar datos de la gráfica
        self.pierna_der.set_data(pierna_der_x, pierna_der_y)
        self.pierna_izq.set_data(pierna_izq_x, pierna_izq_y)
        self.torso.set_data(torso_x, torso_y)
    ...
    def avanzar(self):
        if self.counter < 9:  # Verificar el límite de 0
            self.counter += 1
            pierna_der_x = [self.counter * 2, self.counter * 2]  # Sumar 6 al eje x
            pierna_der_y = [0, 1]
            ...
            cabeza_y = 2  # Nueva posición y de la circunferencia
